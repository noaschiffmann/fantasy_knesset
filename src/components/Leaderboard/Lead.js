...
const LeaderBoard = () => {
    return (
        ...
        {data.slice(0, 3).map((item) => {
            return(
                    <Row className="align-items-center" style={{direction: 'rtl', width: '75%', marginBottom: '2%', height: '35px'}}> 
                        <Col style={{direction: 'rtl'}}><h1 style={{fontFamily: 'Varela Round', fontSize: 'x-small'}}>{item.id}</h1></Col>
        ...
        <Row className="align-items-center" style={{direction: 'rtl', width: '75%', marginBottom: '2%', height: '35px'}}> 
            <Col style={{direction: 'rtl'}}><h1 style={{fontFamily: 'Varela Round', fontSize: 'x-small'}}>574</h1></Col>
