    ...
    return (
      <>
        ...
        <Card className={styles.card}>
          ...
          />
          {flag ? (
            <Avatar alt='coin' name = {data[id].coins} style={{height:'28px', width:'28px', backgroundImage: `url(${coin})`, backgroundSize: 'cover', backgroundPosition: 'center', color: 'black', fontFamily: 'Varela Round', fontSize: 'small', fontWeight: 'bold'}}>{data[id].coins}</Avatar>
          ): null 
          }
