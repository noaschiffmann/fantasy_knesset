    ...
    return(
            <Table style={{direction:'rtl'}}>
                ...
                <div style={{marginTop: '20px'}}><TableRow>
                    ...
                    <TableCell style={{fontFamily: 'Varela Round'}}>&nbsp;&nbsp;&nbsp;<img class="avatar" alt='photo' src={"https://media-exp1.licdn.com/dms/image/C5603AQEu2XN1lvnfvw/profile-displayphoto-shrink_400_400/0/1605026381784?e=1625702400&v=beta&t=CA39sGoTfXJOKzQN4R04fEG5NJcagKFyNVrBO8qXEBc"} style={{ borderRadius: "50%", height: 40, width: 40}}></img> רק ביבי11!</TableCell>
